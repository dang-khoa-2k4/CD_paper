...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{image/ACD-5.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{image/ACD-3.png}
    \caption[Ví dụ ACD]{%
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{image/ACD-1.png}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=1\linewidth]{image/ACD-2.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=1\linewidth]{image/ACD-6.png}
...
\begin{figure}[!htp]
    \centering
    \includegraphics[width=0.5\linewidth]{image/iris_algo_1.png}
...
\begin{figure}[!htp]
    \centering
    \includegraphics[width=0.5\linewidth]{image/iris_2.png}
...
\begin{figure}[!htp]
    \centering
    \includegraphics[width=0.6\linewidth]{image/iris-3.png}
...
\begin{figure}[!htp]
    \centering
    \includegraphics[width=1\linewidth]{image/time-iris.png}
...
\begin{figure}[!htp]
    \centering
    \includegraphics[width=1.0\linewidth]{image/VCC-pipeline.png}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.5\linewidth]{image/VCC-1.png}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.5\linewidth]{image/VCC-2.png}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.5\linewidth]{image/VCC-3.png}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.45\linewidth]{image/VCC-4.png}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=1\linewidth]{image/VCC-5.png}
